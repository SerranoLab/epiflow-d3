...
const App = {
  ...
  init() {
    ...
    this.bindExports();
    this.bindOptions();
    console.log('EpiFlow D3 v1.2.0 initialized');
  },
  ...
  _buildReport() {
    ...
    sections.push(`
      <div class="report-section methods">
        ...
        <p style="font-size:10px;color:#94a3b8;">EpiFlow D3 v1.2.0 · © 2025–2026 Serrano Lab, CReM, Boston University · AGPL-3.0 · Generated ${timestamp}</p>
      </div>
    `);
